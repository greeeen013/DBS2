...
(
	"Name" varchar NULL,
	"CertificatesID" varchar NOT NULL
)
;
...
(
	"Bank_account_number" smallint NOT NULL,
	"End_date" date NULL,
...
ALTER TABLE "Certificates" ADD CONSTRAINT "PK_Certificates"
